...
import { getRecycleBin, restoreQuestion, emptyRecycleBin, deleteFromRecycleBin, deleteMultipleFromRecycleBin, Question } from '../lib/db';
import { toast } from 'react-hot-toast';
import { Trash2, RotateCcw, AlertTriangle, CheckSquare, Square, X, Info, History, Clock } from 'lucide-react';
...
export function RecycleBin({ refreshTrigger, onRefresh }: { refreshTrigger: number, onRefresh: () => void }) {
  ...
  if (questions.length === 0) {
    return (
      <div className="flex-1 flex items-center justify-center text-neutral-400 bg-neutral-50 dark:bg-neutral-950">
        <motion.div 
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                {questions.length} {questions.length === 1 ? 'item' : 'items'} waiting to be restored
              </p>
            </div>
          </div>
            ...
            {isSelectionMode ? (
              ...
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-xl text-sm font-bold transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40 rounded-xl text-sm font-bold transition-all disabled:opacity-50"
                >
